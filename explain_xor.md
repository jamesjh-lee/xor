...
- <img src="https://render.githubusercontent.com/render/math?math=\bar y = f(H*W_3 + b_3) = f(\begin{bmatrix} h_1 & h_2 \end{bmatrix} * \begin{bmatrix} w_5 \\ w_6 \end{bmatrix} + b_3) =
