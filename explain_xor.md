...
| :-: | :-: | :-: | :-: | :-: | :-: |
| 0 | 0 | $sigmoid(-8)\approx 0$ | $sigmoid(3)\approx 1$ | $sigmoid(-5) \approx 0$ | 0 |
| 0 | 1 | $sigmoid(-3)\approx 0$ | $sigmoid(-4)\approx 0$ | $sigmoid(6) \approx 1$ | 1 |
| 1 | 0 | $sigmoid(-3)\approx 0$ | $sigmoid(-4)\approx 0$ | $sigmoid(6) \approx 1$ | 1 |
| 1 | 1 | $sigmoid(2)\approx 1$ | $sigmoid(-11)\approx 0$ | $sigmoid(-5) \approx 0$ | 0 |
